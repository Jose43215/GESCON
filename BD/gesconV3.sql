...
-- Tiempo de generación: 25-05-2022 a las 17:42:53
...
CREATE TABLE IF NOT EXISTS `articulo` (
  ...
  `Fichero` varchar(500) COLLATE utf8_bin NOT NULL,
  `Resumen` text COLLATE utf8_bin NOT NULL,
  `Topicos` varchar(300) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `art_asignados` (
  `Id_ArtAsignados` int NOT NULL AUTO_INCREMENT,
  `Id_Revisor` int NOT NULL,
  `Id_Articulo` int NOT NULL,
  `Id_Revisiones` int NOT NULL,
  PRIMARY KEY (`Id_ArtAsignados`),
...
CREATE TABLE IF NOT EXISTS `congreso` (
  ...
  `NombreCongreso` varchar(500) COLLATE utf8_bin NOT NULL,
  `DescripcionCongreso` text COLLATE utf8_bin NOT NULL,
  `TopicosCongreso` varchar(400) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `espacios` (
  ...
  `Espacio` varchar(100) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `especialidades` (
  ...
  `Especilaidad` varchar(50) COLLATE utf8_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `eventos` (
  ...
  `TituloEvento` varchar(500) COLLATE utf8_bin NOT NULL,
  `DescripcionEvento` text COLLATE utf8_bin NOT NULL,
  `Fecha_Inicio` datetime NOT NULL,
  `Fecha_fFinal` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ponencias` (
  `Id_Ponencias` int NOT NULL AUTO_INCREMENT,
  `TituloPonencia` varchar(500) COLLATE utf8_bin NOT NULL,
  `DescripcionPonencia` text COLLATE utf8_bin NOT NULL,
...
ALTER TABLE `art_asignados`
  ADD CONSTRAINT `art_asignados_ibfk_1` FOREIGN KEY (`Id_Revisiones`) REFERENCES `revisiones` (`Id_Revision`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `art_asignados_ibfk_2` FOREIGN KEY (`Id_Revisor`) REFERENCES `revisor` (`Id_Revisor`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `art_asignados_ibfk_3` FOREIGN KEY (`Id_Articulo`) REFERENCES `articulo` (`Id_Articulo`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `eventos`
  ADD CONSTRAINT `eventos_ibfk_1` FOREIGN KEY (`Id_Espacio`) REFERENCES `espacios_designados` (`Id_EspaciosDesignados`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `eventos_ibfk_2` FOREIGN KEY (`Id_Programa`) REFERENCES `programa` (`Id_Programa`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `ponencias`
  ...
  ADD CONSTRAINT `ponencias_ibfk_3` FOREIGN KEY (`Id_Espacio`) REFERENCES `espacios_designados` (`Id_EspaciosDesignados`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ponencias_ibfk_4` FOREIGN KEY (`Id_Programa`) REFERENCES `programa` (`Id_Programa`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `programa`
--
ALTER TABLE `programa`
  ADD CONSTRAINT `programa_ibfk_1` FOREIGN KEY (`Id_Congreso`) REFERENCES `congreso` (`Id_Congreso`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `revisiones`
--
ALTER TABLE `revisiones`
  ADD CONSTRAINT `revisiones_ibfk_1` FOREIGN KEY (`Id_Revisor`) REFERENCES `revisor` (`Id_Revisor`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `revisiones_ibfk_2` FOREIGN KEY (`Id_Articulo`) REFERENCES `articulo` (`Id_Articulo`) ON DELETE CASCADE ON UPDATE CASCADE;
